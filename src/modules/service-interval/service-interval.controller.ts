...
export class ServiceIntervalController {
  ...
  @ApiOperation({ summary: 'Create service interval' })
  @ApiResponse({ status: 201, description: 'Returns created service interval data' })
  ...
  @ApiOperation({ summary: 'Get many service intervals with search and pagination' })
  @ApiResponse({ status: 200, description: 'Returns service intervals data' })
  ...
  @ApiResponse({ status: 200, description: 'Returns service interval data' })
  @ApiResponse({ status: 404, description: 'No such service interval' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @Get('unique/:id')
  ...
  @ApiOperation({ summary: 'Get service interval by vehicleId and ServiceTypeId' })
  @ApiResponse({ status: 200, description: 'Returns service interval data' })
  @ApiResponse({ status: 404, description: 'No such service interval' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @Get('unique')
  ...
  @ApiOperation({ summary: 'Update service interval' })
  ...
  @ApiOperation({ summary: 'Delete service interval' })
